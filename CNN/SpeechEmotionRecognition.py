...
class SpeechEmotionRecognition:
    ...
    Load Audio File
    '''
    def load_audio(self, filename, sample_rate=16000):
        # Read audio file
    ...
    '''
    def predict_emotion_from_file(self, filename, sample_rate=16000):
        # Read audio file
        y, sr = self.load_audio(filename, sample_rate=sample_rate)
        return self.predict_emotion_from_stream(y, sample_rate=sr)
    ...
    def predict_emotion_from_stream(self, y, chunk_step=16000, chunk_size=49100, predict_proba=False, sample_rate=16000):
        ...
        if y.shape[0] < chunk_size:
            ...
            y = np.pad(y, (pre_length, pad_length - pre_length), mode='constant')
